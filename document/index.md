...
| 박스권 자동 매매 시스템 (v1.4) | 🚧 진행중 | 2026-04-30 | -      | [prd](./prd/grid-trader/prd.md) \| [체크리스트](./prd/grid-trader/checklist.md) \| [호가 가이드](./prd/grid-trader/tick-size-guide.md) \| [단위 테스트](./prd/grid-trader/test-spec-unit.md) \| [통합 테스트](./prd/grid-trader/test-spec-integration.md) |
